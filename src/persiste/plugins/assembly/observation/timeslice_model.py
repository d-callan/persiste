...
class TimeSlicedPresenceModel(ObservationModel):
        ...
        for t, observed_compounds in time_slices.items():
            ...
            for compound in all_compounds:
                ...
                if compound in observed_compounds:
                    ...
                    # Not observed: P(not detect | present) * P(present) +
                    #               P(not detect | absent) * P(absent)
                    p_detect = (
    ...
    def __str__(self) -> str:
        return (
            f"TimeSlicedPresenceModel(det={self.detection_prob:.2f}, "
            f"fp={self.false_positive_prob:.3f})"
        )
